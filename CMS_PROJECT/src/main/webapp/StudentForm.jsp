...
<body>
	<div class="form">
		...
		<div class="input-container ic1">
			<input id="stname" name="stname" class="input" type="text" placeholder=" " />
			<div class="cut"></div>
			<label for="stname" class="placeholder">Enter Name</label>
		</div>
		<div class="input-container ic2">
			<textarea id="staddress" name="staddress" class="input" placeholder=" "></textarea>
			<div class="cut"></div>
			<label for="staddress" class="placeholder">Enter Address</label>
		</div>
		<div class="input-container ic2">
			<label> Department : </label> <select name="stdepartment" id="stdepartment">
		...
		<div class="input-container ic2">
			<input id="stphone" name="stphone" class="input" type="tel" placeholder=" " />
			<div class="cut"></div>
			<label for="stphone" class="placeholder">Phone Number</label>
		</div>
		
		<div class="input-container ic2">
			<input id="stemail" name="stemail" class="input" type="email" placeholder=" " />
			<div class="cut"></div>
			<label for="stemail" class="placeholder">Enter Email</label>
		</div>
		<div class="input-container ic2">
			<input id="stpassword" name="stpassword" class="input" type="password" placeholder=" " />
			<div class="cut"></div>
			<label for="stpassword" class="placeholder">Enter Password</label>
		</div>
		<div class="input-container ic2">
			<input id="stpassword_repeat" name="stpassword_repeat" class="input" type="password"
